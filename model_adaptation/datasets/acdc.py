...
class ACDC(data.Dataset):
    ...
    **Parameters:**
    ...
    id_to_train_id[np.where(id_to_train_id==255)] = voidClass


    def __init__(self, root,  dataset='cityscapes', split='train', mode='fine', target_type='semantic', transforms=None, ACDC_sub = 'night'
               ):
