...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None, k=3, scale=0.0, return_features=False, return_last_feature=False, invariant=None):
        ...
        assert not (self.return_features and self.return_last_feature), "Only one of return_features and return_last_feature can be True"
...
def _resnet(arch, block, layers, pretrained, progress, num_classes=1000, invariant=None, **kwargs):
    model = ResNet(block, layers, num_classes=num_classes, invariant=invariant, **kwargs)
